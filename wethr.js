document.addEventListener("DOMContentLoaded", function () {
 ...
 async function getWeatherData(cityValue) {
   try {
     ...
     // Clear any existing error message when the city is found
     clearErrorMessage();
     ...
     // Display error message only for the specific error
     if (error.message === "City not found. Please try again.") {
